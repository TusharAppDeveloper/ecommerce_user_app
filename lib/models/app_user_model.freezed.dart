...
class _$AppUserModelImpl implements _AppUserModel {
  ...
  @override
  String toString() {
    return 'AppUserModel(uid: $uid, email: $email, phone: $phone, imgUrl: $imgUrl, streetAddress: $streetAddress, displayName: $displayName, userCreationTime: $userCreationTime)';
  }
